  ...
  return (
    <div className="min-h-screen bg-dark-950 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="bg-dark-900/50 backdrop-blur-xl border-b border-dark-700/50 px-6 py-4 flex-shrink-0">
          <div className="flex items-center justify-between">
            <button
              onClick={() => setSidebarOpen(true)}
              className="p-2 text-slate-400 hover:text-white hover:bg-dark-800 rounded-lg transition-colors xl:hidden"
            >
        ...
        {/* Page content */}
        <main className="flex-1 p-6 sm:p-4 overflow-y-auto">
          {children}
        </main>
      </div>
    </div>
