  ...
  return (
    <div className={cn('card overflow-hidden', className)}>
      ...
      {pagination && totalPages > 1 && (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-6 border-t border-dark-700">
            ...
            {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'px-2 sm:px-3 py-2 rounded-lg font-medium transition-colors text-sm',
                    currentPage === page
